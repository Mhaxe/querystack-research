...
const questions = [
  ...
  const categories = ["Python", "Machine Learning", "Web Development", "Data Analysis", "Artificial Intelligence", "Cybersecurity", "Blockchain", "Game Development", "IoT", "DevOps", "Data Engineering", "Mobile App Development", "Cloud Computing", "NLP", "Frontend Development", "Backend Development", "SQL", "Software Testing", "Raspberry Pi", "Ethical Hacking", "AI in Automotive", "Git", "Responsive Web Design", "Blockchain and Cryptocurrency", "Computer Vision", "Mobile App Monetization", "Quantum Computing", "Ethical Considerations in AI", "Machine Learning in Finance", "AR and VR", "Web Scraping", "IoT Applications", "Remote Work", "Data Privacy"];
  

  function determineCategoriesForQuestions(questions, categories) {
      ...
      questions.forEach(question => {
          const postContent = question.content.toLowerCase();
  ...
  const categorizedQuestions = determineCategoriesForQuestions(questions, categories);
  

  categories.forEach(category => {
      console.log(`Questions in the ${category} category:`);
